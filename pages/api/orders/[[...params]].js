...
export const updateOrderStatus = async (req, res, id) => {
	...
	return res.success(result.data, "Order status updated successfully");
};
...
export const updatePaymentStatus = async (req, res, id) => {
	...
	return res.success(result.data, "Payment status updated successfully");
};

export const cancelOrder = async (req, res, id) => {
	const result = await orderService.cancelOrder(id);
	return res.success(result.data, "Order cancelled successfully");
};
